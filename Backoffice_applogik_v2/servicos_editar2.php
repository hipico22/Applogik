...
-->
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Editar Serviços</h1>
                    <!--<p class="mb-4">Editar
                            </p>
-->
                    <!-- DataTales Example -->
		...
		<div class="container">
			<div class="card card-register mx-auto mt-5">
				<div class="card-header" >Editar Serviços</div>
					<div class="card-body">
						<?php
						...
						<form name="form" method="POST" action="servicos_editados.php" onsubmit="return validateForm()">
							<div class="form-group">
									<div class="form-row">
										<div class="col-md-12">
											<div class="form-label-group">
												<input type="number" id="id" name="id_servicos"  value="<?php echo $id;?>" class="form-control" placeholder="Id" readonly="readonly">
												<label for="id">Id Serviço</label>
											</div>
											<br>
											<div class="form-label-group">
												<input type="text" id="nome" name="titulo"  value="<?php echo $Nome;?>" class="form-control" placeholder="Nome" required="required" autofocus="autofocus">
												<label for="nome">Titulo</label>
                                            </div>
                                            <br>
                                            <div class="form-label-group">
												<input type="text" id="nome" name="link"  value="<?php echo $Link;?>" class="form-control" placeholder="Link" required="required" autofocus="autofocus">
												<label for="nome">Link</label>
                                            </div>
                                            <br>
                                            <div class="col-md-12">
					                        <div class="form-label-group">
						                        <input type="file" accept=".jpg,.jpeg,.png" value="<?php echo $Icon;?>" id="fotografia" name="fotografia" class="form-control" required="required"
                                            ...
                                            <br>
                                            <div class="form-label-group">
												<input type="text" id="nome" name="descricao"  value="<?php echo $Descricao;?>" class="form-control" placeholder="Nome" required="required" autofocus="autofocus">
							...
							<input class="btn btn-primary btn-block" type="submit" value="Editar Serviços"></input>
							<div>
								<table>
									<tr>
									<td>
