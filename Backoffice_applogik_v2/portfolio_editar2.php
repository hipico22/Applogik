...
-->
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Editar Portfolio</h1>
                    <!--<p class="mb-4">Editar
                            </p>
-->
                    <!-- DataTales Example -->
		...
		<div class="container">
			<div class="card card-register mx-auto mt-5">
				<div class="card-header" >Editar Portfolio</div>
					<div class="card-body">
						<?php
							...
							$dados = mysqli_fetch_array($resultado);
                                ...
                                $Nome = $dados['nome'];
                                $Class = $dados['class'];
								$Data_filtro = $dados['data_filtro'];	
								$Estado = $dados['estado'];							
								
						?>			
                        	
						<form name="form" method="POST" action="portfolio_editado.php" onsubmit="return validateForm()">
							<div class="form-group">
									<div class="form-row">
										<div class="col-md-12">
											<div class="form-label-group">
												<input type="number" id="id" name="id_portfolio"  value="<?php echo $id;?>" class="form-control" placeholder="Id" readonly="readonly">
												<label for="id">Id Portfolio</label>
											</div>
											<br>
											<div class="form-label-group">
												...
												<label for="nome">Nome Portfolio</label>
											</div>
                                            <br>
											<div class="form-label-group">
												<input type="text" id="nome" name="class"  value="<?php echo $Class;?>" class="form-control" placeholder="Class" required="required" autofocus="autofocus">
												<label for="nome">Class Portfolio</label>
											</div>
                                            <br>
											<div class="form-label-group">
												<input type="text" id="nome" name="data_filtro"  value="<?php echo $Data_filtro;?>" class="form-control" placeholder="Data Filtro" required="required" autofocus="autofocus">
												<label for="nome">Data filtro Portfolio</label>
											</div>
										</div>
									</div>
									<br>
							...
							<input class="btn btn-primary btn-block" type="submit" value="Editar Menu"></input>
							<div>
								<table>
									<tr>
									<td>
