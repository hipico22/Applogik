...
-->
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Editar Menu</h1>
                    <!--<p class="mb-4">Editar
                            </p>
-->
                    <!-- DataTales Example -->
			...
			<div class="card card-register mx-auto mt-5">
				<div class="card-header" >Editar Menu</div>
					<div class="card-body">
						...
						<form name="form" method="POST" action="menu_editado.php" onsubmit="return validateForm()">
							<div class="form-group">
									<div class="form-row">
										<div class="col-md-12">
											<div class="form-label-group">
												<input type="number" id="id" name="id_menu"  value="<?php echo $id;?>" class="form-control" placeholder="Id" readonly="readonly">
                                            ...
                                            <br>
											<div class="form-label-group">
												<input type="text" id="nome" name="class"  value="<?php echo $Class;?>" class="form-control" placeholder="Nome" required="required" autofocus="autofocus">
												<label for="nome">Class Menu</label>
											</div>
                                            <br>
											<div class="form-label-group">
												<input type="text" id="nome" name="link"  value="<?php echo $Link;?>" class="form-control" placeholder="Nome" required="required" autofocus="autofocus">
												<label for="nome">Link Menu</label>
											</div>
										</div>
									</div>
									<br>
